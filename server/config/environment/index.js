...
var all = {
  ...
  twitter: {
    clientID:     process.env.TWITTER_ID || 'GGOEToq5ih3VQDDojrqXw1OWU',
    clientSecret: process.env.TWITTER_SECRET || 'SYwOAUzij8mRJV2ggwSMvaSRaRl4d4MZnHtMF2dYcHIky3uHSF',
